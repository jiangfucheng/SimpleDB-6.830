...
public class Aggregate extends Operator {
    ...
    public Aggregate(OpIterator child, int afield, int gfield, Aggregator.Op aop) {
        ...
        if (gfield != Aggregator.NO_GROUPING) {
            groupFieldType = tupleDesc.getFieldType(gfield);
        }
        if (tupleDesc.getFieldType(afield) == Type.INT_TYPE) {
            this.aggregator = new IntegerAggregator(groupField, groupFieldType, aggregateField, aggregateOp);
        } else {
            this.aggregator = new StringAggregator(groupField, groupFieldType, aggregateField, aggregateOp);
        }
    }
    ...
    private void mergeAll() throws DbException, TransactionAbortedException {
        while (child.hasNext()) {
    ...
    protected Tuple fetchNext() throws TransactionAbortedException, DbException {
        ...
        if (!aggregateIterator.hasNext()) return null;
